...
func (d *decodeState) value() (tender.Object, error) {
	switch d.opcode {
	default:
		panic(phasePanicMsg)
	case scanBeginArray:
...
func (d *decodeState) array() (tender.Object, error) {
	var arr []tender.Object
	for {
...
func (d *decodeState) object() (tender.Object, error) {
...
func (d *decodeState) literal() (tender.Object, error) {
	...
	default: // number
		...
		return &tender.Float{Value: n}, nil
	}
}
